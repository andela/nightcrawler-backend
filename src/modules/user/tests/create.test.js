    ...
    it('should respond with status 201 and user data', (done) => {
      chai.request(app)
        ...
        .end((err, res) => {
          ...
          expect(res.body.data.user.firstName).to.equal(newUser.firstName);
          expect(res.body.data.user.lastName).to.equal(newUser.lastName);
    ...
    it('should respond with error and user data', (done) => {
      chai.request(app)
        ...
        .end((err, res) => {
          ...
          expect(res.body).to.have.property('status', 'error');
          expect(res.body).to.have.property('error');
          expect(res.body.error).to.have.property('user');
          done();
        });
    });
  });
